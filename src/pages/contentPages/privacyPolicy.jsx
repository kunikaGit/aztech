    ...
    <div>
      <div className='container'>
        <div className='terms_condition'>
          ...
          <h3>Personal information used by The lorem</h3>
          <p >When registering, sending an enquiry or booking a holiday home through this site, personal information such as name, phone number and email address will be saved in our database because The lorem needs to communicate important information such as booking confirmation, payment reminders and other booking related information.</p>

          <h3>Personal information use</h3>
          <p>Personal information stored by The lorem will be used for the adequate function of this Site and the service provided, which includes, among others, the following purposes: bookings, enquiries, account administration, marketing activities, payments, sending communications, fraud detection and prevention, analytical purposes.</p>

          <h3>Personal data protection</h3>
          <p>The lorem employs strict security measures to safeguard personal information and prevent disclosure to third parties without the user’s permission. For this purpose the data storage devices are kept in a secure facility with restricted physical access – and firewalls and other measures are used to restrict electronic access. Access to personally identifiable information is only given to internal staff of The lorem requiring the information to perform a specific job. The lorem will keep the user’s data safe thus cooperation with our security checks may be necessary before disclosing any information. Information will be retained for a reasonable period, or as long as legally required. To this extent, payments made through The lorem are done via a third party secure certified payment provider and The lorem does not store the full credit card details and is not liable for errors or losses on payments or money transfers.</p>
          <p>As part of This Site,The lorem provides an internal account called Secure Inbox that allows direct written communication between the Guest and the Owner. For security purposes, The lorem has an automated system that screens all communications for malicious or fraudulent content. That includes spam and the limitation of certain file types. Any sensitive information such as full credit card numbers that can be used for fraud may be masked automatically to ensure the safety of both Owners and Guests. The lorem may also mask contact information which can be used to establish contact outside the Secure Inbox. In case of detecting a communication with malicious content, it may be blocked entirely. All communications sent and received using the Secure Inbox will be stored by The lorem. To the extent permitted by law,The lorem will only access internal communications between Owners and Guests if required by law, if strictly necessary for security or law enforcement purposes, or if The lorem otherwise has a legitimate interest, such as to detect and prevent fraud and misuse. No communications will ever be passed on to a third party except if required by the law. The lorem may analyse anonymized content of communications to improve its services.</p>
          <p>The personal data provided for the registration of the account as well as any other that could be provided during the booking procedure are included in a database called The lorem duly registered with the Spanish Data Protection Agency, owned and processed by The lorem online rentals SL. The acceptance of these terms and conditions implies the express consent to the referred data processing.</p>
