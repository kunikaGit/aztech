...
import Tree from '../../component/referralTree'
const Networks = () => {
    const users = [
    ...
    return (
        <div className='az-table networks'>
            <div className='table-header'>
                ...
                <ul>
                    <li><button className={type === 'table' ? 'active' : ''} onClick={() => setType('table')}>Table</button></li>
                    <li><button className={type === 'tree' ? 'active' : ''} onClick={() => setType('tree')}>Tree</button></li>
                </ul>
            </div>
            {type === 'table' &&
